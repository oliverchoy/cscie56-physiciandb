...
<html>
	...
	<body>
		<a href="#edit-physician" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-physician" class="content scaffold-edit" role="main">
